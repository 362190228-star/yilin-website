...
function numberedImages(folder: string, start: number, end: number, suffix = ''): WorkImage[] {
  return Array.from({ length: end - start + 1 }, (_, index) => {
    ...
    const src = `/assets/projects/${folder}/${number}${suffix}.webp`
...
export const works: Work[] = [
  {
    ...
    cover: '/assets/projects/autoglm/1.webp', images: numberedImages('autoglm', 1, 29), accent: 'sky',
  },
  {
    ...
    cover: '/assets/projects/jd-ai-kit/0.webp', images: numberedImages('jd-ai-kit', 0, 13), accent: 'brass',
  },
  {
    ...
    cover: '/assets/projects/aigc-platform/0.webp', images: numberedImages('aigc-platform', 0, 17), accent: 'clay',
  },
  {
    ...
    cover: '/assets/projects/ziru-home-search/1@2x.webp', images: numberedImages('ziru-home-search', 1, 19, '@2x'), accent: 'clay',
  },
  {
    id: 'yinlang', title: '音浪视觉定义', tag: '概念 App · 视觉设计', summary: '以声音连接同频人群的概念产品',
    detail: '以声音和音乐为线索探索同频社交体验，从视觉语言、交互方式到核心页面建立完整的概念 App 设计表达。',
    cover: '/assets/projects/yinlang/0.webp', images: numberedImages('yinlang', 0, 13), accent: 'moss',
  },
  {
    ...
    cover: '/assets/projects/app-performance-monitoring/0.webp', images: numberedImages('app-performance-monitoring', 0, 12), accent: 'sky',
  },
]
